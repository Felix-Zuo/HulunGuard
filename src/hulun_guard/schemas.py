...
SUPPORTED_PUBLIC_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "collector": {
        ...
        "promise": "Collector reports preserve health, status, ingest, smoke, managed flush, operations status, Prometheus metrics, alert rules, service template, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields.",
    },
}
