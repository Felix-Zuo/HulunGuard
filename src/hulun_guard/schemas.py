...
SUPPORTED_PUBLIC_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "collector": {
        ...
        "promise": "Collector reports preserve health, status, ingest, smoke, shutdown check, managed flush, operations status, Prometheus metrics, alert rules, service template, service lifecycle, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields.",
    },
}
