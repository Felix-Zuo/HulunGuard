...
4. Run tests, validation, calibration, calibration drift review, threat model check, agent compatibility, integration kit verification, adapter matrix, schema compatibility, and retention cleanup dry-run.
