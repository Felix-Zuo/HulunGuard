...
- collector health, status, ingest, smoke, managed flush, operations status, Prometheus metrics, alert rules, service template, service lifecycle, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields
...
- changes collector report fields, including metrics, alert rules, service templates, service lifecycle outputs, status, and smoke outputs
