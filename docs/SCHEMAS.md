...
- collector health, status, ingest, smoke, managed flush, operations status, service template, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields
