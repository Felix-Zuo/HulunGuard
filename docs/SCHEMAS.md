...
- collector health, status, ingest, smoke, managed flush, operations status, Prometheus metrics, service template, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields
...
- changes collector report fields
