...
- collector health, status, ingest, smoke, managed flush, operations status, Prometheus metrics, alert rules, service template, endpoint, queue, auth, limit, response, runtime, generated file, and gate fields
...
- changes collector report fields, including metrics, alert rules, service templates, status, and smoke outputs
